...
<img src="${d.photoURL || 'https://ui-avatars.com/api/?name=' + displayName}" class="w-7 h-7 rounded-full border border-[var(--card-border-color)] object-cover flex-shrink-0">
    ...
    ${streakVal > 0 
        ? `<div class="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-orange-500 to-amber-500 rounded-full shadow-[0_2px_8px_rgba(249,115,22,0.4)] border border-white/20">
    <i class="fa-solid fa-fire text-white text-xs animate-pulse"></i>
    <span class="text-white font-black text-xs whitespace-nowrap">${formatStreak(streakVal)}</span>
</div>`
