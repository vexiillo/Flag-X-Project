...
const translations = {
    en: {
        totalScoreLabel: "XP",
        homeSubtitle: "Test Your Knowledge of the World",
        homePlayQuiz: "Play Quiz",
        homeFlagLibrary: "Flag Library",
        quizModesTitle: "Quiz Modes",
        backToMenu: "Back to Menu",
        continentClashTitle: "Choose a Continent",
        backToQuizModes: "Back to Quiz Modes",
        backToBookmarks: "Back to Bookmarks",
        quizScore: "XP",
        quizStreakLabel: "Streak",
        quizLivesLabel: "Lives",
        timerSecLabel: "sec left",
        quizEnd: "End Quiz",
        resultsTitle: "Quiz Over!",
        resultsFinalScore: "XP Earned",
        resultsPlayAgain: "Play Again",
        libraryTitle: "Flag Library",
        continentLibraryTitle: "Choose a Continent",
        backToLibrary: "Back to Library",
        backButton: "Back",
        endQuizModalTitle: "End Quiz?",
        endQuizModalText: "Are you sure you want to end this quiz? Your XP will be saved.",
        endQuizModalYes: "Yes, End",
        endQuizModalCancel: "Cancel",
        footer: "Flag-X © 2025. All Rights Reserved.",
        ...
        quizPromptFlag: "Which flag is this?",
        quizPromptGuessCapital: "What is the capital of {countryName}?",
        quizPromptYear: "Which year is this flag from?",
        resultsMessage: "You earned {score} XP!",
        timeAttackResultMessage: "You answered {questions} questions and earned {score} XP!",
        survivalResultMessage: "You survived {questions} questions and earned {score} XP!",
        comboResultMessage: "You survived the Combo Challenge for {questions} questions and earned {score} XP!",
        viewDetailBtn: "View Details",
        funFact: "Fun Fact",
        closeBtn: "Close",
        geminiError: "Sorry, we've reached our daily limit. Please try again tomorrow!",
        searchPlaceholder: "Search for a flag...",
        searchCountryPlaceholder: "Search for a country...",
        mode_classic_title: "Classic Mode",
        mode_classic_desc: "Guess 20 official country flags. No time limit.",
        mode_continent_title: "Continent Clash",
        mode_continent_desc: "Focus on flags from a single continent. 20 questions.",
        mode_capital_title: "Capital Guess",
        mode_capital_desc: "Guess the capital city based on the flag. 20 questions.",
        mode_year_title: "Year Guess",
        mode_year_desc: "Guess the year associated with historical flags. 20 questions.",
        mode_time_title: "Time Attack",
        mode_time_desc: "Answer as many questions as possible in 60 seconds.",
        mode_survival_title: "Survival Mode",
        mode_survival_desc: "30 questions, 3 lives. Three mistakes and the game is over.",
        mode_combo_title: "Combo Challenge",
        mode_combo_desc: "Infinite mixed questions, 90 seconds, one life. The ultimate Flag-X challenge!",
        lib_official_title: "Official Countries",
        lib_subdivisions_title: "Subdivisions",
        lib_territories_title: "Territories",
        lib_unofficial_title: "Unofficial",
        lib_historical_title: "Historical",
        lib_organizations_title: "World Organizations",
        lib_continent_title: "Continent Flags",
        ...
        subdivisionSelectionTitle: "Choose a Country",
        territorySelectionTitle: "Choose a Country",
        historicalSelectionTitle: "Choose a Country",
        playQuizBtn: "Play Quiz",
        viewBtn: "View",
        awesomeBtn: "AWESOME!",
        ...
        loginPrompt: "Log in to save your XP to the global leaderboard!",
        ...
        detailNoInfo: "No specific vexillology information available.",
        noDesignAvailable: "No design available.",
        unofficialModalTitle: "Unofficial",
        unofficialModalText: "This flag has no officially recognized legal status. It may be an unofficial flag in real-world use, a proposed design, a hypothetical reconstruction, or a fan-made creation. It is displayed for educational and vexillological purposes only.",
        toastLoginSuccess: "Logged in successfully!",
        toastLoginFailed: "Login failed: ",
        switchAccount: "Switch Account",
        toastSwitchSuccess: "Account switched successfully!",
        toastSwitchFailed: "Failed to switch account: ",
        leaderboardGuestCTA: "Log in to enter the global rankings and compete with others!",
        retryBtn: "Try Again",
        navHome: "Home",
        navPlay: "Play",
        navLibrary: "Library",
        ...
        missedFlagsShort: "Review",
        missedFlagsNone: "Perfect run — no mistakes!",
        ...
        notEnoughBookmarksCapital: "Add at least 4 bookmarked flags with a capital city to start this quiz.",
        bookmarkQuizTypeModalTitle: "Choose Quiz Type",
        bookmarkQuizFlagDesc: "Guess the name from the flag",
        bookmarkQuizCapitalDesc: "Guess the capital city",
        lib_bookmarks_title: "My Bookmarks",
        lib_bookmarks_desc: "Save your favorite flags for quick access and focused study.",
        startBookmarkQuiz: "Study Quiz",
        startBookmarkQuizCapital: "Capital Quiz",
        onboardingWelcomeTitle: "Welcome to Flag-X!",
        onboardingWelcomeText: "Test your knowledge of world flags—from official countries and subdivisions to historical flags and more.",
        onboardingXpTitle: "Earn XP & Level Up",
        onboardingXpText: "Answer correctly to earn XP. Reach Level 50 and compete on the global leaderboard!",
        ...
        leaderboardWeeklyReset: "WEEKLY RESET",
        leaderboardResetsIn: "Resets in",
        leaderboardYou: "You",
        leaderboardSortXP: "XP",
        leaderboardSortStreak: "Streak",
        ...
        profileTotalQuizzesDesc: "Quizzes played",
        profileMotivationNew: "Keep learning!",
        profileMotivationExcellent: "Amazing! You're a flag master!",
        profileMotivationGreat: "Great work! Keep it up!",
        profileMotivationGood: "Good effort! Keep practicing!",
        profileMotivationPractice: "Keep practicing!",
        achievementSheetTitle: "Achievements",
        homeQuickExplore: "Quick Explore",
        leaderboardStreak: "Streak",
        switchModalTitle: "Switch Quiz Mode?",
        switchModalDesc: "Changing the input mode during a quiz will reset all of your current quiz progress.",
        confirmSwitchBtn: "Yes, Reset",
        cancelSwitchBtn: "Cancel",
        notifModalTitle: "Enable Reminders?",
        notifModalDesc: "We'll send you a daily notification to help keep your Streak alive!",
        confirmLogoutTitle: "Log Out?",
        confirmLogoutDesc: "You'll need to log in again to save your progress to the leaderboard.",
        confirmLogoutBtn: "Yes, Log Out",
        confirmSwitchAccTitle: "Switch Account?",
        confirmSwitchAccDesc: "You'll be logged out of this account and asked to sign in with another one.",
        confirmSwitchAccBtn: "Yes, Switch",
        overlayBlockedTitle: "Permission Blocked",
        overlayBlockedText: "It looks like another app running on your screen is preventing this permission popup from working properly. It's a safety measure to prevent anything from interfering behind the scenes.\n\nTry closing any floating bubbles or widgets first, then tap the bell icon to try again. Nothing floating around? Check your phone's app settings for anything with \"display over other apps\" enabled and turn it off if needed. Still stuck? A quick restart usually clears it up.",
        ...
        streakBonusSub: "Applied to all quiz XP while your streak is active",
        leaderboardNoData: "No data for this period.",
        leaderboardNoDataSub: "Be the first to claim the top spot on the leaderboard!",
        notifGrantedTitle: "Flag-X Reminders Active!",
        notifGrantedBody: "Great! We'll remind you to keep your Streak alive.",
        notifNotSupported: "Notifications are not supported on this browser.",
        notifAlreadyActive: "🔔 Streak reminders are already active!",
        notifBlocked: "Notifications are blocked. Enable them in your browser settings.",
        switchDiffModalTitle: "Change Difficulty?",
        switchDiffModalDesc: "Changing the difficulty during a quiz will reset all of your current quiz progress.",
        filterModalTitle: "Filter by Mode",
        sortModalTitle: "Sort By",
        filterAll: "All Modes",
        sortNewest: "Newest First",
        sortHighest: "Highest XP",
        deleteModalTitle: "Delete History",
        delete24h: "Last 24 Hours",
        delete7d: "Last 7 Days",
        delete30d: "Last 30 Days",
        deleteAll: "All History",
        deleteConfirmTitle: "Delete History?",
        confirmDeleteBtn: "Yes, Delete",
        historyDeleted: "History deleted!",
        deleteConfirm24h: "This will permanently delete all quiz history from the last 24 hours. This action cannot be undone.",
        deleteConfirm7d: "This will permanently delete all quiz history from the last 7 days. This action cannot be undone.",
        deleteConfirm30d: "This will permanently delete all quiz history from the last 30 days. This action cannot be undone.",
        deleteConfirmAll: "This will permanently delete ALL of your quiz history. This action cannot be undone.",
        diffDisabledHint: "Difficulty is locked while Input Mode is active",
        typeCapitalPlaceholder: "Type the capital city...",
        typeSubdivisionPlaceholder: "Type the region name...",
        typeOrgPlaceholder: "Type the organization name...",
        yearInputDisabledHint: "Input Mode is unavailable for Year Guess",
        ...
        mode_daily_desc: "10 questions for everyone today. Can you beat your friends?",
        dailyCompleted: "✅ Already completed today! Come back tomorrow.",
        dailyCompletedTitle: "See You Tomorrow!",
        feedbackModalTitle: "Send Feedback",
        feedbackTypeLabel: "What's this about?",
        feedbackTypeFlag: "Suggest a Flag",
        feedbackTypeCorrection: "Report Wrong Info",
        feedbackTypeFeature: "Suggest a Feature",
        feedbackTypeBug: "Report a Bug",
        feedbackEntityLabel: "Related Country/Region (Optional)",
        feedbackEntityPlaceholder: "e.g. Kazakhstan, Tibet...",
        feedbackMessageLabel: "Your Message",
        feedbackMessagePlaceholder: "Tell us more...",
        feedbackSubmitBtn: "Send Feedback",
        feedbackErrorEmpty: "Please write your message first.",
        feedbackErrorType: "Please choose a category first.",
        feedbackCooldown: "Please wait a moment before sending again.",
        feedbackSending: "Sending...",
        feedbackSuccess: "✅ Thank you! Your feedback has been sent.",
        feedbackFailed: "Failed to send. Please try again.",
        homeHeroTagline: "Learn flags. Beat quizzes. Climb the leaderboard.",
        fotdTagline: "A new flag to discover, every single day.",
        streakKeepGoing: "Keep it going!",
        leaderboardViewAll: "View All",
        reviewSub: "See wrong answers",
        shareScoreSub: "Challenge friends",
        backToQuizModesSub: "Choose a mode",
        backToBookmarksSub: "Back to your list",
        legacyDataRestored: "🎉 Your old progress has been restored!"
},
    id: {
        totalScoreLabel: "XP",
        homeSubtitle: "Uji Pengetahuanmu tentang Dunia",
        homePlayQuiz: "Main Kuis",
        homeFlagLibrary: "Pustaka Bendera",
        quizModesTitle: "Mode Kuis",
        backToMenu: "Kembali ke Menu",
        continentClashTitle: "Pilih Benua",
        backToQuizModes: "Kembali ke Mode Kuis",
        backToBookmarks: "Kembali ke Bookmark",
        quizScore: "XP",
        quizStreakLabel: "Streak",
        quizLivesLabel: "Nyawa",
        timerSecLabel: "detik tersisa",
        quizEnd: "Akhiri Kuis",
        resultsTitle: "Kuis Selesai!",
        resultsFinalScore: "XP Diperoleh",
        resultsPlayAgain: "Main Lagi",
        libraryTitle: "Pustaka Bendera",
        continentLibraryTitle: "Pilih Benua",
        backToLibrary: "Kembali ke Pustaka",
        backButton: "Kembali",
        endQuizModalTitle: "Akhiri Kuis?",
        endQuizModalText: "Kamu yakin ingin mengakhiri kuis ini? XP yang diperoleh akan disimpan.",
        endQuizModalYes: "Ya, Akhiri",
        endQuizModalCancel: "Batal",
        footer: "Flag-X © 2025. Hak Cipta Dilindungi.",
        settingsSectionLabel: "Pengaturan",
        settingsLanguage: "Bahasa",
        settingsDifficulty: "Tingkat Kesulitan",
        difficultyEasy: "Mudah",
        difficultyNormal: "Normal",
        difficultyHard: "Sulit",
        settingsContact: "Kontak",
        quizPromptFlag: "Bendera apakah ini?",
        quizPromptGuessCapital: "Apa ibu kota dari {countryName}?",
        quizPromptYear: "Bendera ini berasal dari tahun berapa?",
        resultsMessage: "Kamu mendapatkan {score} XP!",
        timeAttackResultMessage: "Kamu menjawab {questions} soal dan mendapatkan {score} XP!",
        survivalResultMessage: "Kamu bertahan hingga {questions} soal dan mendapatkan {score} XP!",
        comboResultMessage: "Kamu bertahan selama {questions} soal dalam Combo Challenge dan mendapatkan {score} XP!",
        viewDetailBtn: "Lihat Detail",
        funFact: "Fakta Menarik",
        closeBtn: "Tutup",
        geminiError: "Maaf, batas harian kami sudah tercapai. Silakan coba lagi besok!",
        searchPlaceholder: "Cari bendera...",
        searchCountryPlaceholder: "Cari negara...",
        mode_classic_title: "Mode Klasik",
        mode_classic_desc: "Tebak 20 bendera negara resmi. Tanpa batas waktu.",
        mode_continent_title: "Continent Clash",
        mode_continent_desc: "Fokus pada bendera dari satu benua. 20 soal.",
        mode_capital_title: "Tebak Ibu Kota",
        mode_capital_desc: "Tebak ibu kota berdasarkan benderanya. 20 soal.",
        mode_year_title: "Tebak Tahun",
        mode_year_desc: "Tebak tahun yang terkait dengan bendera bersejarah. 20 soal.",
        mode_time_title: "Time Attack",
        mode_time_desc: "Jawab sebanyak mungkin soal dalam 60 detik.",
        mode_survival_title: "Mode Bertahan",
        mode_survival_desc: "30 soal, 3 nyawa. Tiga kesalahan dan permainan berakhir.",
        mode_combo_title: "Combo Challenge",
        mode_combo_desc: "Soal campuran tanpa batas, 90 detik, satu nyawa. Tantangan Flag-X yang sesungguhnya!",
        lib_official_title: "Negara Resmi",
        lib_subdivisions_title: "Subdivisi",
        lib_territories_title: "Wilayah",
        lib_unofficial_title: "Tidak Resmi",
        lib_historical_title: "Bersejarah",
        lib_organizations_title: "Organisasi Dunia",
        lib_continent_title: "Bendera Benua",
        lib_official_desc: "Semua negara berdaulat yang diakui secara internasional.",
        lib_subdivisions_desc: "Hanya mencakup divisi administratif tingkat pertama. Divisi tingkat kedua dan seterusnya tidak termasuk.",
        lib_territories_desc: "Wilayah dependensi dan wilayah seberang laut.",
        lib_unofficial_desc: "Wilayah sengketa dan kawasan dengan status kedaulatan yang masih diperdebatkan.",
        lib_historical_desc: "Bendera yang pernah digunakan oleh negara atau wilayah, tetapi kini sudah tidak digunakan secara resmi.",
        ...
        subdivisionSelectionTitle: "Pilih Negara",
        territorySelectionTitle: "Pilih Negara",
        historicalSelectionTitle: "Pilih Negara",
        playQuizBtn: "Main Kuis",
        viewBtn: "Lihat",
        awesomeBtn: "KEREN!",
        reachedInfo: "Kamu telah mencapai",
        ...
        loginPrompt: "Masuk untuk menyimpan XP-mu ke papan peringkat global!",
        loginBtn: "Masuk dengan Google",
        logoutBtn: "Keluar",
        usernameLabel: "Nama Tampilan (Peringkat)",
        homeLeaderboard: "Papan Peringkat",
        leaderboardTitle: "Pemain Teratas",
        leaderboardUser: "Pemain",
        leaderboardScore: "XP",
        disclaimerTitle: "Catatan Akurasi Bendera",
        disclaimerText: "Di Flag-X, tujuan kami adalah menghadirkan tantangan bendera dunia yang seru dan lengkap! Perlu diketahui bahwa beberapa bendera dalam kategori Subdivisions, Territories, dan Historical Flags diberi label Unofficial. Bendera-bendera ini belum tentu merupakan desain resmi yang berlaku saat ini, karena tidak setiap wilayah, teritori, atau periode sejarah memiliki bendera yang diakui secara resmi atau terdokumentasi dengan baik.\n\nMengapa tetap kami tampilkan? Karena mengenal lebih banyak variasi bendera—termasuk yang paling langka atau sulit dikenali—dapat memperluas pengetahuanmu tentang geografi dunia, sejarah, dan vexillology. Anggap saja ini sebagai latihan untuk melatih mata dan otakmu mengenali simbol-simbol unik dari berbagai penjuru dunia. Selamat belajar dan selamat bermain!",
        toastNameBlank: "Nama tidak boleh kosong! ⚠️",
        toastNameSaved: "Nama berhasil disimpan!",
        ...
        leaderboardErrorSub: "Periksa koneksi internetmu dan coba lagi sebentar lagi.",
        libNoFlags: "Tidak ada bendera yang tersedia.",
        searchNoFlags: "Bendera tidak ditemukan.",
        searchTryDifferent: "Coba kata kunci lain.",
        detailNoInfo: "Tidak ada informasi vexillology yang tersedia.",
        noDesignAvailable: "Tidak ada desain yang tersedia.",
        unofficialModalTitle: "Tidak Resmi",
        unofficialModalText: "Bendera ini tidak memiliki status hukum yang diakui secara resmi. Bendera ini dapat berupa bendera yang digunakan secara tidak resmi, desain usulan, rekonstruksi hipotetis, atau karya penggemar. Bendera ini ditampilkan hanya untuk tujuan edukasi dan vexillology.",
        toastLoginSuccess: "Berhasil masuk!",
        toastLoginFailed: "Gagal masuk: ",
        switchAccount: "Ganti Akun",
        toastSwitchSuccess: "Akun berhasil diganti!",
        toastSwitchFailed: "Gagal mengganti akun: ",
        leaderboardGuestCTA: "Masuk untuk mengikuti peringkat global dan bersaing dengan pemain lain!",
        retryBtn: "Coba Lagi",
        navHome: "Beranda",
        navPlay: "Main",
        navLibrary: "Pustaka",
        ...
        scoredCopied: "Skor disalin ke clipboard!",
        missedFlagsTitle: "Bendera untuk Ditinjau",
        missedFlagsShort: "Tinjau",
        missedFlagsNone: "Sempurna — tanpa kesalahan!",
        correctAnswer: "Benar:",
        wrongAnswer: "Jawaban:",
        correctCapital: "Ibu Kota:",
        wrongCapital: "Ibu Kota:",
        bookmarkAdded: "Ditambahkan ke Bookmark! ⭐",
        bookmarkRemoved: "Bookmark dihapus",
        noBookmarksMsg: "Belum ada bookmark! Tandai bendera di pustaka.",
        noBookmarksSub: "Jelajahi pustaka dan klik ikon bintang pada bendera mana pun untuk menyimpannya di sini agar mudah dipelajari.",
        notEnoughBookmarks: "Tambahkan setidaknya 4 bendera ke Bookmark untuk memulai kuis.",
        notEnoughBookmarksCapital: "Tambahkan setidaknya 4 bendera ke Bookmark yang memiliki ibu kota untuk memulai kuis ini.",
        bookmarkQuizTypeModalTitle: "Pilih Jenis Kuis",
        bookmarkQuizFlagDesc: "Tebak nama dari benderanya",
        bookmarkQuizCapitalDesc: "Tebak ibu kotanya",
        lib_bookmarks_title: "Bookmark Saya",
        lib_bookmarks_desc: "Simpan bendera favoritmu untuk akses cepat dan sesi belajar yang lebih fokus.",
        startBookmarkQuiz: "Kuis Belajar",
        startBookmarkQuizCapital: "Kuis Ibu Kota",
        onboardingWelcomeTitle: "Selamat Datang di Flag-X!",
        onboardingWelcomeText: "Uji pengetahuanmu tentang bendera dunia—dari negara resmi dan subdivisi hingga bendera bersejarah dan banyak lagi.",
        onboardingXpTitle: "Kumpulkan XP & Naik Level",
        onboardingXpText: "Jawab dengan benar untuk mendapatkan XP. Capai Level 50 dan bersaing di papan peringkat global!",
        onboardingStreakTitle: "Bangun Streak-mu",
        onboardingStreakText: "Main setiap hari untuk menjaga streak tetap aktif, simpan bendera untuk dipelajari, dan bagikan skor terbaikmu!",
        skipBtn: "Lewati",
        nextBtn: "Lanjut",
        letsGoBtn: "AYO MULAI!",
        ...
        leaderboardWeeklyReset: "RESET MINGGUAN",
        leaderboardResetsIn: "Reset dalam",
        leaderboardYou: "Kamu",
        leaderboardSortXP: "XP",
        leaderboardSortStreak: "Streak",
        profileTotalQuizzes: "Total Kuis",
        profileAccuracy: "Akurasi",
        profileRank: "Peringkat",
        profileGlobalRank: "Peringkat Global",
        profileLevelLabel: "Level",
        profileMemberSince: "Bergabung sejak {date}",
        profileBestStreak: "Streak Terbaik",
        profileTotalQuizzesDesc: "Kuis dimainkan",
        profileMotivationNew: "Terus belajar!",
        profileMotivationExcellent: "Luar biasa! Kamu memang master bendera!",
        profileMotivationGreat: "Kerja bagus! Terus pertahankan!",
        profileMotivationGood: "Usaha bagus! Terus berlatih!",
        profileMotivationPractice: "Terus berlatih!",
        achievementSheetTitle: "Pencapaian",
        homeQuickExplore: "Jelajah Cepat",
        leaderboardStreak: "Streak",
        switchModalTitle: "Ganti Mode Kuis?",
        switchModalDesc: "Mengubah mode input di tengah kuis akan mengatur ulang seluruh progres kuis yang sedang berjalan.",
        confirmSwitchBtn: "Ya, Atur Ulang",
        cancelSwitchBtn: "Batal",
        notifModalTitle: "Aktifkan Pengingat?",
        notifModalDesc: "Kami akan mengirimkan notifikasi harian untuk membantumu menjaga Streak tetap aktif!",
        confirmLogoutTitle: "Keluar Akun?",
        confirmLogoutDesc: "Kamu perlu masuk kembali untuk menyimpan progres ke papan peringkat.",
        confirmLogoutBtn: "Ya, Keluar",
        confirmSwitchAccTitle: "Ganti Akun?",
        confirmSwitchAccDesc: "Kamu akan keluar dari akun ini dan diminta masuk dengan akun lain.",
        confirmSwitchAccBtn: "Ya, Ganti",
        overlayBlockedTitle: "Izin Diblokir",
        overlayBlockedText: "Sepertinya ada aplikasi lain yang aktif di layarmu sehingga pop-up izin ini tidak dapat berfungsi dengan semestinya. Ini merupakan langkah pengamanan untuk mencegah aplikasi lain mengganggu proses tersebut.\n\nCoba tutup bubble atau widget melayang yang sedang aktif, lalu ketuk ikon lonceng untuk mencoba lagi. Tidak ada yang melayang? Periksa pengaturan aplikasi di HP-mu dan cari aplikasi yang memiliki izin \"tampil di atas aplikasi lain\", lalu matikan jika diperlukan. Masih belum berhasil? Coba restart HP-mu—biasanya cara ini dapat mengatasinya.",
        ...
        streakLegendary: "Dedikasi legendaris! 🏆",
        streakOnFire: "Kamu sedang on fire! Teruskan!",
        streakWeekly: "Streak satu minggu! Konsistensimu luar biasa!",
        streakBonusSub: "Berlaku untuk semua XP kuis selama streak-mu aktif",
        leaderboardNoData: "Tidak ada data untuk periode ini.",
        leaderboardNoDataSub: "Jadilah yang pertama meraih posisi teratas di papan peringkat!",
        notifGrantedTitle: "Pengingat Flag-X Aktif!",
        notifGrantedBody: "Mantap! Kami akan mengingatkanmu untuk menjaga Streak tetap aktif.",
        notifNotSupported: "Notifikasi tidak didukung di browser ini.",
        notifAlreadyActive: "🔔 Pengingat Streak sudah aktif!",
        notifBlocked: "Notifikasi diblokir. Aktifkan melalui pengaturan browser.",
        switchDiffModalTitle: "Ganti Tingkat Kesulitan?",
        switchDiffModalDesc: "Mengubah tingkat kesulitan di tengah kuis akan mengatur ulang seluruh progres kuis yang sedang berjalan.",
        filterModalTitle: "Filter berdasarkan Mode",
        sortModalTitle: "Urutkan",
        filterAll: "Semua Mode",
        sortNewest: "Terbaru",
        sortHighest: "XP Tertinggi",
        deleteModalTitle: "Hapus Riwayat",
        delete24h: "24 Jam Terakhir",
        delete7d: "7 Hari Terakhir",
        delete30d: "30 Hari Terakhir",
        deleteAll: "Semua Riwayat",
        deleteConfirmTitle: "Hapus Riwayat?",
        confirmDeleteBtn: "Ya, Hapus",
        historyDeleted: "Riwayat dihapus!",
        deleteConfirm24h: "Semua riwayat kuis dalam 24 jam terakhir akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.",
        deleteConfirm7d: "Semua riwayat kuis dalam 7 hari terakhir akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.",
        deleteConfirm30d: "Semua riwayat kuis dalam 30 hari terakhir akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.",
        deleteConfirmAll: "SEMUA riwayat kuismu akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.",
        diffDisabledHint: "Tingkat kesulitan terkunci saat Mode Input aktif",
        typeCapitalPlaceholder: "Ketik nama ibu kota...",
        typeSubdivisionPlaceholder: "Ketik nama wilayah...",
        typeOrgPlaceholder: "Ketik nama organisasi...",
        yearInputDisabledHint: "Mode Input tidak tersedia untuk Tebak Tahun",
        ...
        dailyCompleted: "✅ Sudah dimainkan hari ini! Kembali lagi besok.",
        dailyCompletedTitle: "Sampai Jumpa Besok!",
        feedbackModalTitle: "Kirim Masukan",
        feedbackTypeLabel: "Ini tentang apa?",
        feedbackTypeFlag: "Usulkan Bendera",
        feedbackTypeCorrection: "Laporkan Info yang Salah",
        feedbackTypeFeature: "Usulkan Fitur",
        feedbackTypeBug: "Laporkan Bug",
        feedbackEntityLabel: "Negara/Wilayah Terkait (Opsional)",
        feedbackEntityPlaceholder: "cth. Kazakhstan, Tibet...",
        feedbackMessageLabel: "Pesanmu",
        feedbackMessagePlaceholder: "Ceritakan lebih lanjut...",
        feedbackSubmitBtn: "Kirim Masukan",
        feedbackErrorEmpty: "Tulis pesanmu terlebih dahulu.",
        feedbackErrorType: "Pilih kategori terlebih dahulu.",
        feedbackCooldown: "Tunggu sebentar sebelum mengirim lagi.",
        feedbackSending: "Mengirim...",
        feedbackSuccess: "✅ Terima kasih! Masukanmu telah terkirim.",
        feedbackFailed: "Gagal mengirim. Silakan coba lagi.",
        homeHeroTagline: "Pelajari bendera. Taklukkan kuis. Naik ke puncak peringkat.",
        fotdTagline: "Temukan satu bendera baru setiap hari.",
        streakKeepGoing: "Teruskan!",
        leaderboardViewAll: "Lihat Semua",
        reviewSub: "Lihat jawaban yang salah",
        shareScoreSub: "Tantang teman",
        backToQuizModesSub: "Pilih mode",
        backToBookmarksSub: "Kembali ke daftarmu",
        legacyDataRestored: "🎉 Progres lamamu berhasil dipulihkan!"
    }
};
